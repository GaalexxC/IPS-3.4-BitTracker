...
class admin_bitracker_customize_trackerstyle extends ipsCommand
{
	/**
	 * Shortcut for url
	 *
	...
	public function doExecute( ipsRegistry $registry ) 
	{
		...
		$this->form_code	= 'module=customize&amp;section=trackerstyle';
		$this->form_code_js	= 'module=customize&section=trackerstyle';
		...
		$this->request['conf_title_keyword'] = 'bit_styl';
