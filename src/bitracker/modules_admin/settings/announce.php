...
class admin_bitracker_settings_announce extends ipsCommand
{
	/**
	 * Shortcut for url
	 *
	...
	public function doExecute( ipsRegistry $registry ) 
	{
		...
		$this->form_code	= 'module=settings&amp;section=announce';
		$this->form_code_js	= 'module=settings&section=announce';
		...
		$this->request['conf_title_keyword'] = 'bit_ann';
