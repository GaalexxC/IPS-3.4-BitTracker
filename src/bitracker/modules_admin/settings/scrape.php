...
class admin_bitracker_settings_scrape extends ipsCommand
{
	/**
	 * Shortcut for url
	 *
	...
	public function doExecute( ipsRegistry $registry ) 
	{
		...
		$this->form_code	= 'module=settings&amp;section=scrape';
		$this->form_code_js	= 'module=settings&section=scrape';
		...
		$this->request['conf_title_keyword'] = 'bit_scrap';
