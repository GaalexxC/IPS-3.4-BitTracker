...
class admin_bitracker_settings_preferences extends ipsCommand
{
	/**
	 * Shortcut for url
	 *
	...
	public function doExecute( ipsRegistry $registry ) 
	{
		...
		$this->form_code	= 'module=settings&amp;section=preferences';
		$this->form_code_js	= 'module=settings&section=preferences';
		...
		$this->request['conf_title_keyword'] = 'bit';
