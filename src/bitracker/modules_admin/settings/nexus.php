...
class admin_bitracker_settings_nexus extends ipsCommand
{
	/**
	...
	public function doExecute( ipsRegistry $registry ) 
	{
		...
		$this->form_code	= 'module=settings&amp;section=nexus';
		$this->form_code_js	= 'module=settings&section=nexus';
		...
		$this->request['conf_title_keyword'] = 'bit_nexus';
