...
class admin_bitracker_settings_security extends ipsCommand
{
	/**
	 * Shortcut for url
	 *
	...
	public function doExecute( ipsRegistry $registry ) 
	{
		...
		$this->form_code	= 'module=settings&amp;section=security';
		$this->form_code_js	= 'module=settings&section=security';
		...
		$this->request['conf_title_keyword'] = 'bit_sec';
