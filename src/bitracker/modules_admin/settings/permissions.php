...
class admin_bitracker_settings_permissions extends ipsCommand
{
	/**
	 * Shortcut for url
	 *
	...
	public function doExecute( ipsRegistry $registry ) 
	{
		...
		$this->form_code	= 'module=settings&amp;section=permissions';
		$this->form_code_js	= 'module=settings&section=permissions';
		...
		$this->request['conf_title_keyword'] = 'bit_perm';
