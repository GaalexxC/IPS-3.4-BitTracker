...
$dataHookLocations = array(
	...
	array( 'bitrackerAddFile', 'Add Torrent' ),
	array( 'bitrackerEditFile', 'Edit Torrent' ),
	array( 'bitrackerUpdateCategoryInfo', 'Update Torrents Category Info' ),
	array( 'bitrackerRebuildStatsCache', 'Rebuild Torrents Statistics Cache' ),
	array( 'bitrackerAddFileComment', 'Add Torrent Comment' ),
	array( 'bitrackerEditFileComment', 'Edit Torrent Comment' ),
	array( 'bitrackerCommentAddPostSave', 'Add Torrent Comment (post save)' ),
	array( 'bitrackerCommentEditPostSave', 'Edit Torrent Comment (post save)' ),
	array( 'bitrackerCommentPostDelete', 'Delete Torrent Comment (post delete)' ),
	array( 'bitrackerCommentToggleVisibility', 'Toggle Torrent Comment Visibility (post delete)' ),
);