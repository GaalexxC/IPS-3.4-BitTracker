...
/**
 *
 * @class		plugin_bitracker_unapprovedfiles
 * @brief		Moderator control panel plugin: show bit files pending approval
 */
class plugin_bitracker_bitunapprovedfiles
{
	/**
	...
	public function executePlugin( $permissions )
	{
		...
		return $this->registry->getClass('output')->getTemplate('bitracker_other')->moderatorPanel( 'unapproved', $results );
	}
