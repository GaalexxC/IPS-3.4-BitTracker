...
<div class='acp-box'>
	...
	<table class='ipsTable'>
		...
		<tr>
         ...
         <tr>
			<td>
				Recount Peer Stats<br />
				<span class='desctext'>This will recount all the connected seeders and leechers from the peers table and update the torrent data numbers</span>
			</td>
			<td>
				<a href='{$this->settings['base_url']}{$this->form_code}&amp;do=recount_peerstats'>Recount peer numbers</a>
			</td>
		</tr>
		<tr>
			<td>
