...
class public_bitracker_ajax_sidebar extends ipsAjaxCommand 
{
	/**
	 * Class entry point
	 *
	...
	public function doExecute( ipsRegistry $registry ) 
	{
		...
		$this->returnJsonArray( array( 'type' => $type, 'data' => preg_replace('/<!--(.|\s)*?-->/', '', $this->registry->getClass('output')->getTemplate('bitracker')->portalSidebarBlockInsert( $no_lang, $items, $template, $recordIds=array() ) ) ) );
	}
}